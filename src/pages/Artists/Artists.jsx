...
export const Artists = () => {
  const artists = [
    { id: 0,name: "Richard Hershman", image: artist0, specialty: "Realism || Dot Work", description:"When it comes to tattooing realistic portraits, Richard is one of the best in the game.", tattoos:[
      { id: 1, image: "../../assets/Richard0.png", description: "Descripción del tatuaje 1" },
      { id: 2, image: "../../assets/Richard1.png", description: "Descripción del tatuaje 2" },
      { id: 3, image: "../../assets/Richard2.png", description: "Descripción del tatuaje 2" },
      { id: 4, image: "../../assets/Richard3.png", description: "Descripción del tatuaje 2" },
      { id: 5, image: "../../assets/Richard4.png", description: "Descripción del tatuaje 2" },
      { id: 6, image: "../../assets/Richard5.png", description: "Descripción del tatuaje 2" },
    ]},
  ...
  const artistsRow1 = artists.slice(0, 4);
  const artistsRow2 = artists.slice(4, 8);
